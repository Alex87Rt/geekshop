...
urlpatterns = [
    ...
    path('categories/create/', adminapp.CategoryCreateView.as_view(), name='admin_categories_create'),
    path('categories/update/<int:pk>/', adminapp.CategoryUpdateView.as_view(), name='admin_categories_update'),
    path('categories/remove/<int:pk>/', adminapp.CategoryDeleteView.as_view(), name='admin_categories_remove'),
]